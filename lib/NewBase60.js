...
function DateToSxg(dateObj) {
  var sinceEpoch = Date.UTC(dateObj.getUTCFullYear(), dateObj.getUTCMonth(), dateObj.getUTCDate(), dateObj.getUTCHours(), dateObj.getUTCMinutes(), dateObj.getUTCSeconds(), dateObj.getUTCMilliseconds());
  var epochDays = Math.round(sinceEpoch / 86400000);
...
function SxgToDate(sxg) {
  ...
  var dateObj = new Date().setTime(0);
